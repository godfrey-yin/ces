...
App.prototype.init = function() {
	...
	function startCES(applier, cb){
		...
		var event_listener = services.get('EventListener');
		var event_sender = services.get('EventSender');

		// initialize event listener and sender
		var recv = new Receiver(event_listener, applier);
		var sender = new Sender(event_sender, applier);
